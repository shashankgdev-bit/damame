...
Current result over 540 generated sessions (20 per each of 27 archetypes — 16 planting
one waste pattern each, 11 innocent near-misses built one unit under a threshold — seeded):

| rule | recall | precision |
|---|---|---|
| all 16 rules | **1.00** | **1.00** |
...
metrics → 16 detectors → local web dashboard + terminal / HTML / JSON reports,
